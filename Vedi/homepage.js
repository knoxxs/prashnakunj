$(document).ready(function(){
	...
	$.get( 
             ...
             function(data) {
				...
				var answerString;
				jQuery('#siteDescription').after('<br><h4 class="entry-title"><span class="title" style="text-align:left"><a onClick="quesClick(this)" id="' + data[0].question.QID + '">'+data[0].question.string+'</a></span><br><br></h4><div class="entry-excerpt" id="best_answer_1" style="text-align:left">'+answers[0]+'</div>');	
				for (var j=1;j<10;j++)
				{
					$('#best_answer_' + j).after('<br><h4 class="entry-title"><span class="title" style="text-align:left"><a onClick="quesClick(this)" id="' + data[j].question.QID + '">'+data[j].question.string+'</a></span><br><br></h4><div class="entry-excerpt" id="best_answer_'+(j+1)+'" style="text-align:left">'+answers[j]+'</div>');	
				}
...
function pop_tag_click(e){
	switch(e.id)
	{
		case 'computer_science': 
			setCookie('tag', 'computer science', 1);
			var saved_tag = getCookie('username');
			if(undefined != saved_tag)
				window.location = 'tag_signed.html';
			else
		...
		case 'control_statements': 
			setCookie('tag', 'control statements', 1);
			var saved_tag = getCookie('username');
			if(undefined != saved_tag)
				window.location = 'tag_signed.html';
			else
		...
		case 'switch_case': 
			...
			break;
		case 'dynamic_motion': 
			setCookie('tag', 'dynamic motion', 1);
			var saved_tag = getCookie('username');
			if(undefined != saved_tag)
				window.location = 'tag_signed.html';
			else
